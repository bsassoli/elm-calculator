...
var $author$project$Calculator$First = {$: 'First'};
...
var $author$project$Calculator$ChangeSign = {$: 'ChangeSign'};
var $author$project$Calculator$ClearAll = {$: 'ClearAll'};
var $author$project$Calculator$ClearLast = {$: 'ClearLast'};
var $author$project$Calculator$Comma = {$: 'Comma'};
var $author$project$Calculator$Divide = {$: 'Divide'};
var $author$project$Calculator$Equal = {$: 'Equal'};
var $author$project$Calculator$InputNumber = function (a) {
	return {$: 'InputNumber', a: a};
};
var $author$project$Calculator$Minus = {$: 'Minus'};
var $author$project$Calculator$Operator = function (a) {
	return {$: 'Operator', a: a};
};
var $author$project$Calculator$Plus = {$: 'Plus'};
var $author$project$Calculator$Times = {$: 'Times'};
var $author$project$Calculator$keys = _List_fromArray(
	[
		...
		{
		action: $author$project$Calculator$InputNumber(7),
		cls: 'button num-button',
		val: '7'
	},
		{
		action: $author$project$Calculator$InputNumber(8),
		cls: 'button num-button',
		val: '8'
	},
		{
		action: $author$project$Calculator$InputNumber(9),
		cls: 'button num-button',
		val: '9'
	},
		{
		action: $author$project$Calculator$Operator($author$project$Calculator$Plus),
		cls: 'button calc-action-button',
		val: '+'
	},
		{
		action: $author$project$Calculator$InputNumber(4),
		cls: 'button num-button',
		val: '4'
	},
		{
		action: $author$project$Calculator$InputNumber(5),
		cls: 'button num-button',
		val: '5'
	},
		{
		action: $author$project$Calculator$InputNumber(6),
		cls: 'button num-button',
		val: '6'
	},
		{
		action: $author$project$Calculator$Operator($author$project$Calculator$Minus),
		cls: 'button calc-action-button',
		val: '-'
	},
		{
		action: $author$project$Calculator$InputNumber(1),
		cls: 'button num-button',
		val: '1'
	},
		{
		action: $author$project$Calculator$InputNumber(2),
		cls: 'button num-button',
		val: '2'
	},
		{
		action: $author$project$Calculator$InputNumber(3),
		cls: 'button num-button',
		val: '3'
	},
		{
		action: $author$project$Calculator$Operator($author$project$Calculator$Divide),
		cls: 'button calc-action-button',
		val: '/'
	},
		{
		action: $author$project$Calculator$InputNumber(0),
		cls: 'button num-button zero',
		val: '0'
	},
		{
		action: $author$project$Calculator$Operator($author$project$Calculator$Comma),
		cls: 'button num-button',
		val: '.'
	},
		{action: $author$project$Calculator$Equal, cls: 'button calc-action-button', val: '='}
	]);
var $author$project$Calculator$initialModel = {currentOperand: $author$project$Calculator$First, display: '0', firstOperand: 0, keyboard: $author$project$Calculator$keys, operator: '', result: 0, secondOperand: 0, title: 'Elm Calculator'};
...
var $author$project$Calculator$Second = {$: 'Second'};
var $author$project$Calculator$evaluate = function (op) {
	switch (op) {
		case '+':
...
var $author$project$Calculator$handleDisplayOperator = function (op) {
	switch (op.$) {
		case 'Plus':
			return '+';
		case 'Minus':
		...
		switch (msg.$) {
			case 'InputNumber':
				...
				return _Utils_update(
					model,
					{
						display: ((model.display === '0') || A2(
							$elm$core$List$member,
							model.display,
							_List_fromArray(
								['AC', 'MC', '+/-', 'x', '-', '+', '/']))) ? ('' + $elm$core$String$fromFloat(num)) : _Utils_ap(
							model.display,
							$elm$core$String$fromFloat(num)),
						firstOperand: function () {
							var _v1 = model.currentOperand;
							if (_v1.$ === 'First') {
								return A2(
									...
									$elm$core$String$toFloat(
										_Utils_ap(
											$elm$core$String$fromFloat(model.firstOperand),
											$elm$core$String$fromFloat(num))));
							} else {
								return model.firstOperand;
							}
						}(),
						secondOperand: function () {
							var _v2 = model.currentOperand;
							if (_v2.$ === 'Second') {
								return A2(
									$elm$core$Maybe$withDefault,
									0,
									$elm$core$String$toFloat(
										_Utils_ap(
											$elm$core$String$fromFloat(model.secondOperand),
											$elm$core$String$fromFloat(num))));
							} else {
								return model.secondOperand;
							}
						}()
					});
			case 'Operator':
				...
				return _Utils_update(
					model,
					{
						currentOperand: function () {
							var _v3 = model.currentOperand;
							if (_v3.$ === 'First') {
								return $author$project$Calculator$Second;
							} else {
								return $author$project$Calculator$First;
							}
						}(),
						display: $author$project$Calculator$handleDisplayOperator(type_),
			...
			case 'Equal':
				...
				return _Utils_update(
					model,
					{
						currentOperand: $author$project$Calculator$First,
						display: $elm$core$String$fromFloat(result),
						firstOperand: result,
						operator: '',
						result: result,
						secondOperand: 0
...
var $author$project$Calculator$renderKeyboardItem = function (key) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(key.cls),
				$elm$html$Html$Events$onClick(key.action)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(key.val)
			]));
};
var $author$project$Calculator$renderKeyboard = function (data) {
	return A2($elm$core$List$map, $author$project$Calculator$renderKeyboardItem, data);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$href('static/styles.css')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Calculator$renderKeyboard(model.keyboard))
							]))
					]))
			]));
};
